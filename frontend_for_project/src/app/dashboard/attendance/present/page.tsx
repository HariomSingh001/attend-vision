  ...
  useEffect(() => {
    const loadStudents = async () => {
      try {
        ...
        const presentStudents = frontendStudents.filter(s => s.attendance === 'present');
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>A list of all students marked as present today.</CardDescription>
      </CardHeader>
      <CardContent>
              ...
              {students.length > 0 ? (
                ...
                <TableRow>
                  <TableCell colSpan={3} className="h-24 text-center">
                    No students are marked as present.
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
